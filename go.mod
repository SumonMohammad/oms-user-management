module gitlab.techetronventures.com/core/oms-user-management
...
require (
	...
	gitlab.techetronventures.com/core/backend v1.0.0
...
replace gitlab.techetronventures.com/core/backend => ../backend
